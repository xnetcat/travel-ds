...
class ExpediaListing(models.Model):
    ...
    class Meta:
        app_label = "expedia"
        db_table = "expedia_listing"


class ExpediaPrice(models.Model):
    listing = models.ForeignKey(ExpediaListing, on_delete=models.DO_NOTHING)
