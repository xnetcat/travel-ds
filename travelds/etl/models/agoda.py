...
class AgodaListing(models.Model):
    ...
    class Meta:
        app_label = "agoda"
        db_table = "agoda_listing"


class AgodaPrice(models.Model):
    listing = models.ForeignKey(AgodaListing, on_delete=models.DO_NOTHING)
